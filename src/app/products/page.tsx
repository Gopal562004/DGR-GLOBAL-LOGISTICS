      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
        ...
        <div className="border-b border-slate-200 pb-8 mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold font-heading text-slate-950 uppercase tracking-tight">
            UN APPROVED PACKAGING & DRUMS CATALOG
          </h1>
          <p className="text-sm sm:text-base text-slate-600 mt-2 max-w-3xl leading-relaxed">
            Direct manufacturer & supplier pricing for genuine IATA/IMO certified 4GV fiberboard boxes, open-top HDPE drums, Jerry cans, and hazard warning labels with official test certificates.
          </p>
