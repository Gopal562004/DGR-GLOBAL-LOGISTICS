...
*Direct Operations Lead: Mayur Kadam (+91 9028345261)*`;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-900/70 backdrop-blur-xs overflow-y-auto">
      <div className="relative w-full max-w-xl bg-white border border-slate-300 shadow-2xl my-auto max-h-[92vh] flex flex-col">
        
        {/* Header */}
        <div className="bg-slate-900 text-white px-5 sm:px-6 py-4 flex items-center justify-between border-b-2 border-amber-500 shrink-0">
          <div>
          ...
          <button
            onClick={onClose}
            className="text-slate-400 hover:text-white p-1.5 focus:outline-none"
            ...
            <div className="py-8 text-center bg-white space-y-4">
              ...
              <div className="pt-2">
                <button
                  ...
                  className="bg-slate-900 text-white font-bold text-xs uppercase px-6 py-3"
                >
                  Close Window
                </button>
              </div>
            ...
            <form className="space-y-4 text-slate-900">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-slate-50 border border-slate-300 px-3.5 py-2.5 text-xs sm:text-sm focus:outline-none focus:border-amber-500 rounded-none"
                >
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-center justify-end gap-2 border-t border-slate-200">
                <button
                  ...
                  className="w-full sm:w-auto bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs uppercase px-5 py-3 flex items-center justify-center gap-1.5 transition-colors"
                >
                ...
                <button
                  type="button"
                  onClick={handleEmail}
                  className="w-full sm:w-auto bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs uppercase px-5 py-3 flex items-center justify-center gap-1.5 transition-colors"
                >
